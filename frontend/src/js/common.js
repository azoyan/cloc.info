...
export function createRepositoryIcon(input, width, height) {
    if (input.includes("github.com")) { return `<img width=${width} height=${height} src="${githubSvg}" alt="Open repository" class="float-start">` }
    else if (input.includes("gitlab.com")) { return `<img width=${width} height=${height} src="./gitlab-3.svg" alt="Open repository" class="float-start">` }
    else if (input.includes("bitbucket.org")) { return `<img width=${width} height=${height} src="./bitbucket-icon.svg" alt="Open repository" class="float-start">` }
    else if (input.includes("codeberg.org")) { return `<img width=${width} height=${height} src="./codeberg-svgrepo-com.svg" alt="Open repository" class="float-start">` }
    else if (input.includes("gitea.com")) { return `<img width=${width} height=${height} src="./gitea.svg" alt="Open repository" class="float-start">` }
    else { return `<img width=${width} height=${height} src="./git-icon.svg" alt="Open repository" class="float-start">` }
}
